function mqtt(){
    ...
    self.subscribe = function(){
        ...
        self.mqtt.onSubscribe(function(data) {
            ...
            // It's most probably the new URL for JS program, download and flash it
    ...
    self.test_publish = function(){
        ...
        // Use the char code for / and merge them to create //. It is done because otherwise the string is failing.
        var div = s + s;
        ...
        // Merge all to create http://www.indigost.com/code/code.js

        var link = protocol + div + website + s + path + s + file;

        // Publish and return code
